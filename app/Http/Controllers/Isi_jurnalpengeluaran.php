...
class Isi_jurnalpengeluaran extends Controller
{
    ...
    public function edit_jurnal_umum(Request $r)
    {
        $no_id = $r->no_id;
        $ttl_rp = $r->ttl_rp;
        $ket = $r->keterangan;
        ...
        DB::table('tb_asset_umum')->where('no_nota',  $no_nota)->delete();
        for ($x = 0; $x < count($id_debit); $x++) {
    ...
    public function edit_jurnal_atk(Request $r)
    {
        $no_id = $r->no_id;
        $ttl_rp = $r->ttl_rp;
        $ket = $r->keterangan;
        ...
        DB::table('table_atk')->where('no_nota',  $no_nota)->delete();
