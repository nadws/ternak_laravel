<form action="{{route('save_aktiva')}}" method="post">
    ...
    <div class="row">
        ...
        @foreach ($aktiva as $a)
        @php
        $total += round($a->debit,0) - round($a->kredit,0) < 1 ? '0' : $a->b_penyusutan;
            @endphp
            @endforeach
            ...
            <div class="col-lg-3">
                ...
                <input type="hidden" name="id_akun_debit" value="{{$akun->id_relation_debit}}" class="form-control"
                    id="" readonly>
            </div>
            <div class="col-lg-2">
            ...
            <div class="col-lg-3">
                ...
                <input type="hidden" name="id_akun_kredit" value="{{$akun->id_akun}}" class="form-control" id=""
                    readonly>
            </div>
            <div class="col-lg-2">
    ...
    <div class="row mt-4">
        ...
        @foreach ($aktiva as $a)
        @if (round($a->debit,0) - round($a->kredit,0) < 1) @php continue; @endphp @endif <div class="col-lg-2 mt-2">
    ...
    <div class="col-lg-3 mt-2">
        <input type="text" style="text-align: right" class="form-control"
            value="{{round($a->debit,0) - round($a->kredit,0)}}" readonly>
    </div>
    <div class="col-lg-3 mt-2">
        <input type="text" style="text-align: right" name="b_penyusutan[]" class="form-control b_penyusutan"
            value="{{$a->b_penyusutan}}">
        <input type="hidden" style="text-align: right" name="id_post[]" class="form-control" value="{{$a->id_post}}">
    </div>
    @endforeach
    </div>
