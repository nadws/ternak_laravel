                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <a class="btn btn-costume btn-sm float-right" href="{{route('add_pupuk')}}"><i
                                ...
                                <table class="table" id="example2" style="white-space: nowrap;text-align: center">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>P-{{$i->no_nota}}</td>
                                            <td>{{number_format($i->full,0)}}</td>
                                            <td>{{number_format($i->h_full,0)}}</td>
                                            <td>{{number_format($i->setengah,0)}}</td>
                                            <td>{{number_format($i->h_setengah,0)}}</td>
