...
<div class="row">
    ...
    <div class="col-md-1">
        <div class="form-group">
            ...
            <input type="text" class="form-control  qty_aktiva" name="qty[]" value="1" required>
        </div>
    </div>
    ...
    <div class="col-md-2">
        <div class="form-group">
            ...
            <select name="id_satuan[]" class="form-control select satuan " required>
    ...
    <div class="col-md-2">
        <div class="form-group">
            ...
            <input type="text" class="form-control total_aktiva" name="ttl_rp[]" required>
        </div>
    </div>
    <div class="col-md-2">
        <div class="form-group">
            <label for="list_kategori">PPN</label>
            <input type="text" class="form-control ppn " name="ppn[]" required>
        </div>
    </div>
    <div class="col-md-2">
        <div class="form-group">
            <label for="list_kategori">Rp + Pajak</label>
            <input type="text" class="form-control ppn_ttl_rp" name="ttl_rp[]" required>
        </div>
    </div>
    <hr>
